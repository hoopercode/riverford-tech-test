        ...
        <div class="form">
          ...
          <div className="form__item form__item--password">
            ...
            <input
              ...
              required
            />
            <button className="form__show-button" onClick={togglePassword}>
              show
            </button>
          </div>
          ...
          <div className="form__item  form__item--phone">
            ...
            <input
              className="form__box--phone form__box"
              type="tel"
              name="phone"
            />
          </div>
          ...
          <div className="form__item form__item--info">
            ...
            <textarea
              className="form__box form__box--info"
              type="text"
              cols="40"
              rows="5"
              name="moreInfo"
          ...
          <div
            className="form__item form__item--confirm"
